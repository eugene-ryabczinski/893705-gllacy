...
var sliderInit = function() {
	for (var i=0; i < slides.length; i++) {
		if (i == currentIndex) {
			...
			toggles[i].classList.toggle("slider-toogle-current");
			body.classList.add("slide-"+(i+1)+"-bg");
		} else {
			slides[i].classList.remove("slide-show");
			toggles[i].classList.remove("slider-toogle-current");
			body.classList.remove("slide-"+(i+1)+"-bg");
		}
	}	
}
